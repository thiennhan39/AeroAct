...
from AirVLN_utils.CN import CN
...
class Param:
    def __init__(self):
        ...
        project_prefix = Path(str(os.getcwd())).parent.resolve() # absolute path to the project root
        ...
        self.parser.add_argument('--run_type', type=str, default="eval", help="run_type in [collect, train, eval]")
        self.parser.add_argument("--model_path",type=str,default="checkpoints/ft_8B_frames_8_ratio1.0_epochs_1_v1/checkpoint-3000",help="Path to the model checkpoint")
        self.parser.add_argument("--sample_temperature", type=float,default=0.0,help="Temperature for sampling")
        self.parser.add_argument("--split",type=str,default="val_seen",choices=["val_seen", "val_unseen", "test"],help="Dataset split to use" )
        ...
        self.parser.add_argument('--collect_type', type=str, default="TF", help="seq2seq in [TF, dagger, SF]") # what different collect types mean?
        

        self.parser.add_argument('--maxInput', type=int, default=300, help="max input instruction")
        

        self.parser.add_argument("--dagger_it", type=int, default=1) # for dagger ?
        ...
        self.parser.add_argument('--inflection_weight_coef', type=float, default=1.9) # for what
        # ignore episode ids
        self.parser.add_argument('--ignore_specific_episode', action="store_true")
        # parameters for dagger missing files
    ...
    + "https://huggingface.co/docs/accelerate/usage_guides/big_modeling",
        ...
        self.parser.add_argument('--awq_apply', action="store_true")
